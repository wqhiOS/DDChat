...
@implementation DDDateConvertTool
/**
 获取现在的时间戳
                                                         ...
                                                         hour:(NSInteger)hour
{
    ...
    {
        //  一天前，显示日期
        dateString = [self dateConvertTimeStampToStringWithTimeStamp:timeStamp dateDisplayType:DDDateDisplayType_Date customTypeString:nil];
    }
                                    ...
                                    directionType:(DDPreviousDateDirectionType)directionType
{
    ...
    //  新的时间戳
    long newTimeStamp ;
    if(directionType == DDPreviousDateDirectionType_Before)
    {
        //  之前
...
/**
 ...
 @return 转换类型
 */
+ (NSString *)getDateDisplayTypeWithType:(DDDateDisplayType)dateDisplayType
                        customTypeString:(NSString *)customTypeString
{
    ...
    {
        case DDDateDisplayType_Default:
        {
            timeTypeString = @"yyyy-MM-dd HH:mm:ss";
            break;
        }
        case DDDateDisplayType_Date:
        {
            timeTypeString = @"yyyy-MM-dd";
            break;
        }
        case DDDateDisplayType_Time:
        {
            timeTypeString = @"HH:mm";
            break;
        }
        case DDDateDisplayType_Custom:
        {
            //  自定义类型不正确的话设置默认类型
